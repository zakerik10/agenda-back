...
class EmployeesRegistrationTestCase(unittest.TestCase):
    """
    Pruebas unitarias para las rutas de Empleados.
    """
    ...
    def setUp(self):
        ...
        with self.app.app_context():
            ...
            self.test_client_id = employee.id_employee
            self.headers = {
    ...
    def test_registration_success(self):
        ...
        with self.app.app_context():
            employee = db.session.get(Employees, 2) # El primer usuario creado es ID 1 (testuser), el nuevo es ID 2
